...
let body = addBody(chassis)
console.log(body)

let wheels = addWheels(chassis)
console.log(wheels)

let engine = addEngine(chassis)
console.log(engine)

let steeringWheel = addSteeringWheel(chassis)
console.log(steeringWheel)

let driveTrain = addDriveTrain(chassis)
